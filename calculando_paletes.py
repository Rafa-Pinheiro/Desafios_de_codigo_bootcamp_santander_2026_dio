...
def qtd_paletes(total_caixas, capacidade_palete):
  paletes = total_caixas // capacidade_palete
  return paletes if total_caixas % capacidade_palete == 0 else paletes + 1

paletes_necessarios = qtd_paletes(total_caixas, capacidade_palete)
